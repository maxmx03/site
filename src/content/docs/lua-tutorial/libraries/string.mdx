...
export const codeFormatExample = `
local hello = "ola %s"
local world = "mundo"
...
<Tabs>
  <TabItem label="lua">
    <Code code={codeFormatExample} lang="lua" />
  </TabItem>
...
export const codeGmatchExample = `
...
export const codeGmatchExampleOutput = `
Lua
é
uma
linguagem
...
<Tabs>
  <TabItem label="lua">
    <Code code={codeGmatchExample} lang="lua" />
  </TabItem>
  <TabItem label="console">
    <Code code={codeGmatchExampleOutput} lang="bash" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="lua">
    <Code code={codeAllexample} lang="lua" />
  </TabItem>
  <TabItem label="console">
    <Code code="Ol" lang="bash" />
  </TabItem>
</Tabs>

<Aside title="Nota">
  `string.match` retorna o primeiro padrão encontrado, se não encontrar nenhum,
  retorna nil.
</Aside>

### [set]

export const codeSetExample = `
...
export const codeSetExampleOutput = `
O
a
u
o
...
<Tabs>
  <TabItem label="lua">
    <Code code={codeSetExample} lang="lua" />
  </TabItem>
  <TabItem label="console">
    <Code code={codeSetExampleOutput} lang="bash" />
  </TabItem>
</Tabs>

### [^set]

export const codeSetNotExample = `
local texto = "Ola, mundo!"
...
export const codeSetNotExampleOutput = `
l
,
...
<Tabs>
  <TabItem label="lua">
    <Code code={codeSetNotExample} lang="lua" />
  </TabItem>
  <TabItem label="console">
    <Code code={codeSetNotExampleOutput} lang="bash" />
  </TabItem>
</Tabs>
